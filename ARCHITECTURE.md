...
### P0-007B assignment patterns and scheduled work (delivered; IMPLEMENTING evidence)

Authoritative contract: `briefs/p0-007b-assignment-patterns-scheduled-work.md` **r1**, D-038-D-040. Baseline: merged A at **51322e0**. Branch `brief/p0-007b-assignment-patterns-scheduled-work`. Migration **014**, shared assignment/composition resolver, draft preview, Unassigned storage, and Kitchen/Bathroom/Cats/Trash UI journeys are implemented; Build Report is `reports/P0-007B-r1-build-report.md`.
