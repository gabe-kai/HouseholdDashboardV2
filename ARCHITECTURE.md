...
- **Current repository truth:** Integrated `main` at `7cba3a6` contains accepted **P0-006A r2** via PR #12, the A toast/CI correction, and B planning. The Project Lead accepted A after screenshots and local use. Plan navigation, focused editors, saved URLs, accessible reorder, and local evidence are integrated. P0-006B r1 readiness is committed at `25c3c48` on its brief branch and accepted by Architecture; B is authorized but not implemented.
