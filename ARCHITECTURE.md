...
- **Current repository truth:** Integrated `main` at `409d147` (PR #14) contains technically accepted **P0-006A r2**, **P0-006B r1**, and **P0-006C r1**, including C implementation `5605ab8` and family-order correction `e8a93d5`, through migration 010. The current P0-007A branch adds responsibility implementation and migrations 011–012 at Project Lead commit `fd91c8a`; Architecture returned **FIX REQUIRED**, not acceptance. The Project Lead accepted A after screenshots/local use and exercised B calendar setup; exhaustive C Product acceptance is not inferred.
...
Authoritative contract: `briefs/p0-007a-household-responsibility-foundation.md` **r1**, D-035–D-037. Base: integrated `main` **409d147**; READY review `7226987`, implementation authorization `a6890cc`, delivered implementation **fd91c8a**. Migrations 011–012, responsibility APIs/client, mixed views and acknowledged activity clear exist on the brief branch. R1–R5 corrections are substantially delivered; re-acceptance `reports/P0-007A-r1-architecture-reacceptance.md` withholds acceptance for partial AT4/7/12/15 evidence and remaining definition-kind/ownership storage invariants. The following bullets remain the intended contract, not a claim that every invariant has passed. First of three slices; B/C remain lighter roadmap horizons and are not newly authorized.
