...
- **Current repository truth:** Integrated `main` at `409d147` (PR #14) contains technically accepted **P0-006A r2**, **P0-006B r1**, and **P0-006C r1**, including C implementation `5605ab8` and family-order correction `e8a93d5`. Migrations run through 010. The Project Lead accepted A after screenshots/local use and exercised B calendar setup; exhaustive C Product acceptance is not inferred. P0-007A below is planned, not implemented.
