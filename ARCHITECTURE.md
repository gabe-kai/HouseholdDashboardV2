...
### P0-007C-2 Household Display and read-only dashboard (implementing)

Authoritative contract: `briefs/p0-007c-2-household-display-read-only-dashboard.md` **revision 1**, D-043-D-045. Baseline: integrated C-1 at **ef39a89**. Engineering readiness is **READY** and Architecture has returned **ACCEPT / PROCEED** (2026-09-25); implementation proceeds on `brief/p0-007c-2-household-display-read-only-dashboard`.
