...
- **Current repository truth:** Integrated `main` at `409d147` (PR #14) contains technically accepted **P0-006A r2**, **P0-006B r1**, and **P0-006C r1**, including C implementation `5605ab8` and family-order correction `e8a93d5`, through migration 010. The current P0-007A branch adds responsibility implementation and migrations 011–013 at Project Lead commit `bb21d74`; Architecture technically accepted r1 after the deterministic P0-006B AT9 seam was stabilized and the independent suite passed. The Project Lead accepted A after screenshots/local use and exercised B calendar setup; exhaustive C Product acceptance is not inferred.
...
Authoritative contract: `briefs/p0-007a-household-responsibility-foundation.md` **r1**, D-035–D-037. Base: integrated `main` **409d147**; READY review `7226987`, implementation authorization `a6890cc`, accepted implementation **bb21d74**. Migrations 011–013, responsibility APIs/client, mixed views and acknowledged activity clear exist on the brief branch. Final evidence is in `reports/P0-007A-r1-architecture-reacceptance.md`; independent `npm test` is 168/168 and Engineering PR/RC/Vite gates are green. First of three slices; B/C remain lighter roadmap horizons and are not newly authorized.
