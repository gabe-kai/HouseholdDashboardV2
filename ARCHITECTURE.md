...
### P0-004B planned routine-audience contract
...
- **Routine source semantics (planned P0-004B):** A routine revision retains direct-membership and group selections separately. At least one source is required, but an empty selected group is valid. Resolution is household/date scoped and produces each membership at most once.
